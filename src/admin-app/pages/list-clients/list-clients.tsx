...
{/* Ye hai delete wala system permanent delete wala */}
                                {/* {userState?.user?.role == RoleType.admin && (
                                  <a
                                    onClick={() => {
                                      openModal("dt");
                                ...
                                {userState?.user?.role == RoleType.admin && (
                                  ...
                                  onClick={() =>
                                    ...
                                    className={`${user?.role !== RoleType.admin  ? "d-block" : "d-none"}`}
                                  >
                                   { user?.isLogin ?  <span  style={{ color: "red" }}><PersonRemoveIcon /> Deactivate </span> : <span  style={{ color: "green" }}><PersonAddIcon  /> Activate</span> }
                                    {`(${user.username})`}
                                  </a>
                                )}
