  ...
  return (
    <>
      ...
      <div className="ledger-container">
        <h2 className="ledger-title">All Agent Ledger</h2>
        ...
        <div className="table-section overflow-auto">
          <table className="ledger-table">
            ...
            <tbody>
              {lena.map((row) => (
                <tr key={row.ChildId}>
                  <td  style={{color:"blue" , textDecoration:"underline" }}><CustomLink to={`/all-settlement/${row.ChildId}`}>{row.agent}</CustomLink></td>
